...
if ( phpversion() > 5 ) {
	...
	register_activation_hook( WP_PLUGIN_DIR . '/most-popular-posts/most-popular-posts.php', 'WMP_system::install' );
	register_deactivation_hook( WP_PLUGIN_DIR . '/most-popular-posts/most-popular-posts.php', 'WMP_system::uninstall' );
